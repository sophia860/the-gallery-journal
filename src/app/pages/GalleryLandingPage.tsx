  ...
  return (
    <nav 
      ...
      style={{
        ...
        borderBottom: scrolled ? '1px solid rgba(196, 162, 101, 0.15)' : 'none',
      }}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-8">
            ...
            >
              <span 
                className="text-sm"
                style={{ filter: 'drop-shadow(0 0 6px rgba(196, 162, 101, 0.5))' }}
              >
                🌙
              </span>
              <span 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-20 scroll-reveal">
            <h2 
              ...
              style={{ 
                color: '#f5f0e8',
                textShadow: '0 0 30px rgba(196, 162, 101, 0.25)' 
              }}
            >
              The Two Doors
            </h2>
              ...
              <div className="relative">
                <div className="mb-6">
                  <span 
                    ...
                    style={{ color: 'rgba(196, 162, 101, 0.6)' }}
                  >
                    Curated Journal
                  </span>
                </div>
            ...
            <div className="flex gap-8 items-start scroll-reveal">
              <div 
                ...
                style={{
                  ...
                  boxShadow: '0 0 20px rgba(196, 162, 101, 0.3)',
                }}
              >
                <span 
