...
export function GalleryLandingPage() {
  return (
    <div className="min-h-screen bg-[#FAF8F5] relative">
      ...
      {/* FOYER - Featured Poem Full Viewport */}
      <motion.section 
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          >
            I thought you'd been queer<br />
            longer than that
          </motion.h1>

          {/* Poem excerpt - breathing, generous */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <p className="italic">
              Perhaps because I have been—<br />
              in the way I looked at girls in seventh grade,<br />
              in the way I couldn't explain<br />
              why I felt more myself<br />
              in borrowed clothes,<br />
              in spaces between.
            </p>
            <p className="italic opacity-70">
              You don't measure queerness<br />
              in years or coming-out stories.<br />
              You measure it in the quiet knowing,<br />
              the way you finally exhale<br />
          ...
          >
            <p className="font-['Libre_Baskerville'] text-base text-[#8B7355]">
              Nix Carlson
            </p>
            <p className="font-['Courier_New'] text-xs text-[#8B7355]/60 mt-1 tracking-wider">
